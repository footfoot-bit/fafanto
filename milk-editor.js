...
//event
  ...
  (() => {
    ...
    const elems = [POSLI,POSNW.elements['title'],PAGLI,PAGNW.elements['title'],document.querySelectorAll('.postcap *')[0],document.querySelectorAll('.pagecap *')[0],CONF.querySelector('fieldset')];
